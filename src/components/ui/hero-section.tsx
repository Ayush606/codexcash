                ...
                <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                    <div>
                        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                            Unlock Top Dev Talent With Solana Coding Contests
                        </h1>
                        <p className="mt-3 text-xl text-muted-foreground">
                            Host coding contests with Solana rewards to find the perfect solution for your project
                        </p>
                        {/* Buttons */}
                        <div className="flex justify-center m-4 space-x-4 md:justify-start md:mx-0 md:my-4 ">
                            <Link href="/signup">
